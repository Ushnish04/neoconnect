        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ marginBottom: '2rem' }}>
            ...
            <select
              ...
              onBlur={(e) => e.target.style.borderColor = 'rgba(255,255,255,0.1)'}
            >
              <option value="staff" style={{ background: '#112240' }}>Staff</option>
              <option value="secretariat" style={{ background: '#112240' }}>Secretariat</option>
              <option value="case_manager" style={{ background: '#112240' }}>Case Manager</option>
              <option value="admin" style={{ background: '#112240' }}>Admin</option>
            </select>
          </div>
